...
comida2 = "hamburguesa"
comida3 = "sushi"
comida4 = "torta/yogurt de jalea"



# a) Con .format()
# (tu código aquí)
print("Me encanta comer {}, {}, {} y {}".format(comida1, comida2, comida3, comida4))

# b) Con f-string
# (tu código aquí)

print(f"Me encanta comer {comida1}, {comida2}, {comida3} y {comida4}")
